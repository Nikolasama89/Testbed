...
public class Account {
     ...
     * @throws Exception    if the ssn is not valid or the balance is not sufficient or amount is negative
     */
    ...
    /**
     * Returns as a String representation of the {@link Account} state
     * @return  the string-based format of the state {@link Account}
     */
